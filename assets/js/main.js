(function ($) {
    ...
    $(document).on('click',".quantity-up",function() {
      var spinner = jQuery(this),input = spinner.parent().find('input[type="text"]'),max = jQuery(this).parent().parent().attr('data-max');
    ...
    $(document).on('click',".quantity-down",function() {
      var spinner = jQuery(this),input = spinner.parent().find('input[type="text"]'),min = jQuery(this).parent().parent().attr('data-min');
      var oldValue = parseFloat(input.val());
      if (oldValue <= min) {
        var newVal = oldValue;
      } else {
