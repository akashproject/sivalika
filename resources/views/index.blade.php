    ...
    <div class="container-fluid booking pb-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">Sivalika</span></h1>
        ...
        <div class="container-xxl px-0 wow zoomIn" data-wow-delay="0.1s">
            <div class="row g-0">
                ...
                <div class="col-md-6">
                    <div class="video" style="background: linear-gradient(rgba(15, 23, 43, .1), rgba(15, 23, 43, .1)), url(assets/img/sivalika-belur.jpg);">
        ...
        <!-- Video Start -->
         ...
         <div class="container-xxl px-0 wow zoomIn" data-wow-delay="0.1s">
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="video" style="background: linear-gradient(rgba(15, 23, 43, .1), rgba(15, 23, 43, .1)), url(assets/img/sivalika-howrah.webp);">
                    </div>
                </div>
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5">
